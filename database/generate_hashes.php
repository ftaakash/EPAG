...
$roles = [
    ['Alice Employee',  'employee@epag.com',  'employee',  'employee',  1],
    ['Bob Manager',     'manager@epag.com',   'manager',   'manager',   1],
    ['Carol Finance',   'finance@epag.com',   'finance',   'finance',   2],
    ['Dave Materials',  'materials@epag.com', 'materials', 'materials', 2],
    ['Eve Admin',       'admin@epag.com',     'admin',     'admin',     2],
];
...
$rows = [];
foreach ($roles as [$name, $email, $pass, $role, $dept]) {
