<?php requireRole(['finance']); ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title>EPAG — Finance Dashboard</title>
...
<main class="container">
  <h2 class="page-title">Finance Approval Queue</h2>
  ...
  <div class="card">
    <div class="card-header">
      <h3>Requests Awaiting Finance Review</h3>
      <span class="badge"><?= count($requests) ?> pending</span>
    </div>
    <div class="card-body p-0">
      <?php if (empty($requests)): ?>
        <p class="empty-state">✓ No requests pending finance review.</p>
      <?php else: ?>
        <table class="table">
          <thead>
            <tr>
